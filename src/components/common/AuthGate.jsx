 ...
 * account to save to Firestore) and AccountSettings (nothing to configure
 * without a profile).
 */
    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-start justify-center pt-6 sm:items-center sm:pt-0">
        <div className="card max-w-sm w-full text-center mx-4 shadow-lg">
          <h2 className="font-display font-bold text-lg text-ink mb-1">{t("auth.lockedTitle")}</h2>
          <p className="text-ink/60 text-sm mb-4">{t("auth.lockedSubtitle")}</p>
          <button
